...
struct AnnatatonPin: View {
    ...
    var body: some View {
        VStack(spacing: 0){
            VStack{
                AnnatatonPinView(image: place.typeName ?? "kinder", type: place.type ?? "")
